...
public class RequestStandScreen extends HandledScreen<RequestStandScreenHandler> {
    private static final Identifier TEXTURE = Identifier.of(VillagerBusiness.MOD_ID, "textures/gui/request_stand_gui.png");
...
//        RenderSystem.setShaderTexture(0, TEXTURE);
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float tickProgress) {
        ...
        context.drawText(textRenderer, Text.translatable("village_business.request"), x + 93, y + 56, 0xFF444444, false);
        ...
        if (handler.blockEntity.hasFilter()) {
            if (handler.blockEntity.getItemPrice() != null) {
                ...
                context.drawCenteredTextWithShadow(textRenderer, Text.literal("x" + getConvertedPrice(handler.blockEntity.getRequestPrice())), x + 48 + 36, y + 25, enoughEmeralds
                                                                                                                                                                    ? 0xFFffffff
                                                                                                                                                                    : 0xFFff8888);
                boolean enoughSpace = handler.blockEntity.hasEnoughSpace();
                context.drawCenteredTextWithShadow(textRenderer, Text.literal("x" + itemPrice.getSellAmount(1)), x + 93 + 36, y + 25, enoughSpace
                                                                                                                                      ? 0xFFffffff
                                                                                                                                      : 0xFFff8888);
                context.drawCenteredTextWithShadow(textRenderer, getSaleChanceText(handler.blockEntity.getRequestChance()), x + 48, y + 43, 0xFFffffff);
                context.drawCenteredTextWithShadow(textRenderer, getSaleFrequencyText(handler.blockEntity.getRequestCooldown()), x + 48, y + 57, 0xFFffffff);
            } else {
                context.drawCenteredTextWithShadow(textRenderer, Text.literal("-"), x + 48 + 36, y + 25, 0xFFff8888);
                context.drawCenteredTextWithShadow(textRenderer, Text.literal("-"), x + 93 + 36, y + 25, 0xFFff8888);
            ...
            context.drawCenteredTextWithShadow(textRenderer, Text.literal("-"), x + 48 + 36, y + 25, 0xFFcccccc);
            context.drawCenteredTextWithShadow(textRenderer, Text.literal("-"), x + 93 + 36, y + 25, 0xFFcccccc);
